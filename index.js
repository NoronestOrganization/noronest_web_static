...
const translations = {
  en: {
    ...
    step_3_title: "Game Recommendation",
    ...
    service_device_title: "Neurotechnology Supportive Stimulation Device",
    service_device_desc: "Meet our advanced technology frequency device that supports cognitive health and neuroplasticity (learning, adaptation, recovery) at the cellular level. In addition to traditional methods, this device provides targeted stimulation without surgical intervention in the management of Alzheimer's and other neurodegenerative diseases. Working together with our AI algorithms, the device directly contributes to the preservation of cognitive skills and the enhancement of cellular vitality.",
    ...
    feature_noninvasive: "Non-Invasive Stimulation",
    feature_neuroplasticity: "Neuroplasticity Support",
    feature_adaptive_mod: "Adaptive Modulation",
    feature_clinical_panel: "Clinical Panel Integration",
  ...
  tr: {
    ...
    service_device_title: "Nöroteknolojik Destekleyici Stimülasyon Cihazı",
    service_device_desc: "Bilişsel sağlığı ve nöroplastisiteyi (öğrenme, adaptasyon, iyileşme) hücresel düzeyde destekleyen ileri teknoloji frekans cihazımızla tanışın. Geleneksel yöntemlere ek olarak bu cihaz, Alzheimer ve diğer nörodejeneratif hastalıkların yönetiminde, hedefe yönelik cerrahi müdahale olmadan stimülasyon sağlar. Yapay zeka algoritmalarımızla birlikte çalışan cihaz, bilişsel becerilerin korunmasına ve hücresel canlılığın artırılmasına doğrudan katkıda bulunur.",
    ...
    feature_noninvasive: "Non-İnvaziv Stimülasyon",
    feature_neuroplasticity: "Nöroplastisite Desteği",
    feature_adaptive_mod: "Adaptif Modulasyon",
    feature_clinical_panel: "Klinik Panel Entegrasyon",
